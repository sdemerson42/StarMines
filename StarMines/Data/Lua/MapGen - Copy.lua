function MapGen_tryDir(bc, mapAry, dir, x, y, mapIndex)
	...
	if math.random(1,2) == 1 then
		bc:addSceneData("Mine"..mapIndex, "scene", false, 1, "BotSpawnPoint", 32*(l+2), 32 * (t+2), "")
	end
...
function MapGen_calls(bc)
	...
	while call.label ~= "nil" do
		if call.label == "generate" then
			...
			bc:createNewScene("Mine"..mapIndex[1], "1920,1080,96,96","800,600,.25,.25,.416,.555,400,300")
			bc:addSceneData("Mine"..mapIndex[1], "scene", false, 1, "MineLogic", 0, 0, "")
			bc:addSceneData("Mine"..mapIndex[1], "scene", false, 1, "RedGuy", 928, 448, "")
